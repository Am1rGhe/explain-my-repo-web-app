              ...
              {status === "authenticated" && session?.user ? (
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-lg border border-app-border bg-app-button text-app-muted text-sm font-medium py-2.5 px-4 hover:bg-app-border hover:text-app-main transition-colors cursor-pointer"
                  >
                    Sign out
                  </button>
                </div>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-app-border bg-app-button text-app-main text-sm font-medium py-2.5 px-4 hover:bg-app-border transition-colors cursor-pointer"
                >
